...
const messages = {
  en: {
    ...
    hideDeadlines: "Show deadlines in calendar",
    showDeadlines: "Show deadlines at top",
  ...
  nb: {
    ...
    hideDeadlines: "Vis frister i kalenderen",
    showDeadlines: "Vis frister øverst",
  ...
  it: {
    ...
    hideDeadlines: "Mostra scadenze nel calendario",
    showDeadlines: "Mostra scadenze in alto",
  ...
  de: {
    ...
    hideDeadlines: "Fristen im Kalender anzeigen",
    showDeadlines: "Fristen oben anzeigen",
    ...
    summonDeadline: "+ Frist",
    summonDescription: "+ Beschreibung",
